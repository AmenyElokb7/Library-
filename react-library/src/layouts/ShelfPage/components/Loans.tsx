...
export const Loans = () => {
    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            let authState = true
if (authState)  {
                const url = `http://127.0.0.1:8083/api/books/secure/currentloans`;
    ...
    async function returnBook(bookId: number) {
        const url = `http://127.0.0.1:8083/api/books/secure/return?bookId=${bookId}`;
        const requestOptions = {
            method: 'PUT',
            headers: {
                'Authorization': 'Basic ' + localStorage.getItem('basicAuth'),
    ...
    async function renewLoan(bookId: number) {
        const url = `http://127.0.0.1:8083/api/books/secure/renew/loan?bookId=${bookId}`;
        const requestOptions = {
            method: 'PUT',
            headers: {
                'Authorization': 'Basic ' + localStorage.getItem('basicAuth'),
